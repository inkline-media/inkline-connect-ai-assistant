<?php
/**
 * Inline SVG — Font Awesome Pro 7 fa-solid fa-sparkles.
 *
 * Bundled with the plugin so sites without a Font Awesome Pro kit
 * still get the brand sparkle glyph. The path comes from
 * @fortawesome/fontawesome-pro and is shipped under our Commercial
 * License — see https://fontawesome.com/license.
 *
 * Expects an optional $icaia_svg_class string for the class attribute.
 *
